...
export class OrderService {
  ...
  async del(userTelegramId: number): Promise<any> {
    return await this.orderModel.deleteMany({ userTelegramId });
  }
  // async getButtonByName(button: string): Promise<Order | null> {
